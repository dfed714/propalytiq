      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 sm:space-x-6 text-xs text-gray-600">
            <div className="flex items-center space-x-1">
              ...
              <span className="whitespace-nowrap">1000+ investors</span>
            </div>
            <div className="flex items-center space-x-1">
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="whitespace-nowrap">Industry recognised</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="text-center p-6 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300">
            ...
            {/* ROI Graphic - Removed animate-spin class */}
            <div className="mt-4 h-16 flex items-center justify-center">
        ...
        {/* Hero Image with overlay graphics */}
        <div className="relative rounded-2xl overflow-hidden shadow-2xl">
          <Image
            alt="House Placeholder"
            src="/images/house-placeholder.png"
            width={1200}
            height={400}
