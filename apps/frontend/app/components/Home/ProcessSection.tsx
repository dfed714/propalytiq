  ...
  const steps = [
    {
      ...
      description: 'Simply paste a Rightmove or Zoopla link, or manually enter property details to begin your analysis.'
    },
    {
      number: '02',
      title: 'Select your investment strategy',
      description: 'Choose from Buy-to-Let, Buy-Refurbish-Refinance (BRR), Serviced Accommodation, or HMO strategies.'
    },
    {
      number: '03',
      title: 'Receive smart analysis and insights',
      description: 'Get comprehensive investment breakdowns with ROI projections, risk assessment, and tailored recommendations.'
    }
  ];
