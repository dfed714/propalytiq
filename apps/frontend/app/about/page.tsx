      ...
      <div className="max-w-7xl mx-auto py-12 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-purple-100">
            ...
            <p className="text-gray-600">
              Property professionals with decades of combined experience
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-purple-100">
            ...
            <h3 className="text-lg font-semibold mb-2">Precision Analysis</h3>
            <p className="text-gray-600">
              Advanced algorithms for accurate investment insights
            </p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-purple-100">
            ...
            <p className="text-gray-600">
              Reliable data you can depend on for major decisions
            </p>
          </div>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <p className="text-lg text-gray-700 mb-6">
              ...
              technology professionals who saw first-hand how existing
              investment analysis tools were either too complex, too expensive,
              or too basic for most investors.
            </p>
            <p className="text-lg text-gray-700 mb-6">
            ...
            <p className="text-lg text-gray-700">
              ...
              informed decisions by providing comprehensive investment analysis
        ...
        <div className="purple-gradient-bg text-white rounded-xl p-10 text-center">
          ...
          <p className="text-xl mb-8 max-w-xl mx-auto">
            Join thousands of investors who are making smarter property
            decisions with Propalytiq.
          </p>
          <Button
            asChild
            size="lg"
